        ...
        const nvl::Affine3d& currentTransformation2)
{
    ...
    Point v1 = currentTransformation1 * (skeleton1.jointBindPose(targetJoint1) * Point(0,0,0));
    Point v2 = currentTransformation2 * (skeleton2.jointBindPose(targetJoint2) * Point(0,0,0));
    Point t = v1 - v2;
