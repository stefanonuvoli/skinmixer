#ifndef QUAD_PATCH_ASSEMBLER_H
#define QUAD_PATCH_ASSEMBLER_H
...
#include "quad_field_tracer.h"
#include "quad_utils.h"
#include "quad_field_smoother.h"
...
//        std::cout<<std::flush;
    ...
    void InitField()
    {
        ...
        //vcg::tri::io::ExporterPLY<MeshType>::Save(mesh,"test_field.ply");
    ...
    void FixCorners()
    {
        ...
        for (size_t i=0;i<Patches.size();i++)
        {
            ...
            //vcg::tri::io::ExporterPLY<MeshType>::Save(currMesh,"patch2.ply");
        }
    }
...
//    }
    ...
    void FixSmallCC()
    {
        ...
        std::vector<std::vector<size_t> > ComponentsVect;
        ComponentsVect = QuadBoolean::internal::findConnectedComponents(mesh);
                            ...
                            std::vector<std::vector<std::vector<std::pair<size_t,size_t> > > > &BorderEdges)
    {
        ...
        for (size_t i=0;i<Patches.size();i++)
        {
            ...
            if (Corners.back().size()!=Patches[i].ConvexVertIndex.size())
            {
                ...
                vcg::tri::io::ExporterPLY<MeshType>::Save(*Patches[i].PatchMesh,"test_patch.ply");
                assert(0);
    ...
    void FixHoles()
    {
        ...
        Components = QuadBoolean::internal::findConnectedComponents(NewHoles);
